...
function Header()
{
    ...
    $this->Cell(0,6,'Számla kiszallitasrol',0,1,'C');
    $this->Ln(10);
...
$pdf->Table($link,'SELECT product_name AS "Termek megnevezese", product_item_number AS "Termek cikkszama" FROM products');
$pdf->Ln();
